...
exports.getProductByName = async (req, res) => {
  try {
    ...
    res.status(StatusCodes.OK).json({
      ...
      code: StatusCodes.OK,
      data: json,
      message: "Ürün adı görüntüleme başarılı!",
      timestamp: new Date(),
    });
  } catch (error) {
    res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({
...
exports.getProductsByCategory = async (req, res) => {
  try {
    ...
    res.status(StatusCodes.OK).json({
      ...
      code: StatusCodes.OK,
      data: json,
      message: "Ürün kategorisi görüntüleme başarılı!",
      timestamp: new Date(),
    });
  } catch (error) {
    res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({
...
exports.getProductsWithStock = async (req, res) => {
  try {
    ...
    res.status(StatusCodes.OK).json({
      ...
      code: StatusCodes.OK,
      data: json,
      message: "Stok listesi görüntüleme başarılı!",
      timestamp: new Date(),
    });
  } catch (error) {
    res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({
...
exports.getProductsWithStockCategory = async (req, res) => {
  try {
    ...
    res.status(StatusCodes.OK).json({
      ...
      code: StatusCodes.OK,
      data: json,
      message: "Stokları kategorize listeleme başarılı!",
      timestamp: new Date(),
    });
  } catch (error) {
    res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({
...
exports.getProductsPriceGreater = async (req, res) => {
  try {
    ...
    res.status(StatusCodes.OK).json({
      ...
      code: StatusCodes.OK,
      data: json,
      message: "Fiyeya göre listeleme başarılı!",
      timestamp: new Date(),
    });
  } catch (error) {
    res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({
...
exports.getProductsPriceRange = async (req, res) => {
  try {
    ...
    res.status(StatusCodes.OK).json({
      ...
      code: StatusCodes.OK,
      data: json,
      message: "Fiyat aralığı listeleme başarılı",
      timestamp: new Date(),
    });
  } catch (error) {
    res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({
